...
# Export reliability and validity results
write.csv(
  rhoC_AVE(hsr_pls),
  "outputs/reliability_ave_results.csv",
  row.names = FALSE
)
...
write.csv(
  hsr_pls$path_coef,
  "outputs/direct_effects.csv",
  row.names = TRUE
)

# Export outer loadings
write.csv(
  hsr_pls$outer_loadings,
  "outputs/outer_loadings.csv",
  row.names = TRUE
)

# Export specific indirect effects
write.csv(
  specific_indirect_effects,
  "outputs/specific_indirect_effects.csv",
  row.names = FALSE
)